...
from kbeilsmith_Expression.kbeilsmith_ExpressionImpl import kbeilsmith_Expression
from kbeilsmith_Expression.kbeilsmith_ExpressionServer import MethodContext
...
class kbeilsmith_ExpressionTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('kbeilsmith_Expression'):
        ...
        cls.serviceImpl = kbeilsmith_Expression(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_kbeilsmith_Expression_" + str(suffix)
